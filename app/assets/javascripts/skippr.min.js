(function () {
  var a = (function () {
    ...
    return (
      ...
      (a.prototype.navBuild = function () {
        ...
        else if ("bubble" == b.settings.navType) var d = "skippr-nav-element-bubble";
            ...
            "slide" == b.settings.transition &&
              b.$photos.each(function () {
                ...
                c > e && (a = f - g * (c - e)),
                  e > c && (a = f + g * (e - c)),
                  d.addClass("disabled"),
                  $(this).velocity({ left: a + "px" }, b.settings.speed, b.settings.easing, function () {
      ...
      (a.prototype.autoPlay = function () {
        ...
        timer = setInterval(function () {
          ...
          if (c == a.count) var d = a.$element.find(".skippr-nav-element").eq(0);
          else var d = b.next();
          a.change(d);
  ...
  ($.fn.skippr = function (b) {
    ...
    ($.fn.skippr.defaults = { transition: "slide", speed: 1e3, easing: "easeOutQuart", navType: "block", childrenElementType: "div", arrows: !0, autoPlay: !1, autoPlayDuration: 5e3, keyboardOnAlways: !0, hidePrevious: !1, logs: !1 });
}.call(this),
  !(function (a, b, c, d) {
    function e(a) {
    ...
    var s = (a.Velocity = a.velocity = r.extend(a.Velocity || {}, {
      ...
      Sequences: {},
      Easings: {},
      defaults: { queue: "", duration: m, easing: n, complete: null, display: null, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0 },
      animate: function () {},
      debug: !1,
    }));
    ...
    var v = (s.CSS = {
      RegEx: { valueUnwrap: /^[A-z]+\((.*)\)$/i, wrappedValueAlreadyExtracted: /[0-9.]+ [0-9.]+ [0-9.]+( [0-9.]+)?/, valueSplit: /([A-z]+\(.+\))|(([A-z0-9#-.]+?)(?=\s|$))/gi },
      Hooks: {
        templates: {
          ...
          if (8 >= o) e = r.css(a, c);
            ...
            if (!f) {
              if ("height" === c && "border-box" !== v.getPropertyValue(a, "boxSizing").toString().toLowerCase())
                return a.offsetHeight - (parseFloat(v.getPropertyValue(a, "borderTopWidth")) || 0) - (parseFloat(v.getPropertyValue(a, "borderBottomWidth")) || 0) - (parseFloat(v.getPropertyValue(a, "paddingTop")) || 0) - (parseFloat(v.getPropertyValue(a, "paddingBottom")) || 0);
              if ("width" === c && "border-box" !== v.getPropertyValue(a, "boxSizing").toString().toLowerCase())
                return a.offsetWidth - (parseFloat(v.getPropertyValue(a, "borderLeftWidth")) || 0) - (parseFloat(v.getPropertyValue(a, "borderRightWidth")) || 0) - (parseFloat(v.getPropertyValue(a, "paddingLeft")) || 0) - (parseFloat(v.getPropertyValue(a, "paddingRight")) || 0);
            }
            var h;
      ...
      setPropertyValue: function (a, c, d, e, f) {
        ...
        if ("scroll" === c) f.container ? (f.container["scroll" + f.direction] = d) : "Left" === f.direction ? b.scrollTo(d, f.alternateValue) : b.scrollTo(f.alternateValue, d);
          ...
          if ((v.Normalizations.registered[c] && ((d = v.Normalizations.registered[c]("inject", a, d)), (c = v.Normalizations.registered[c]("name", a))), (g = v.Names.prefixCheck(c)[0]), 8 >= o))
            try {
              a.style[g] = d;
            } catch (j) {
      ...
      (s.animate = function () {
        function a() {
          function a() {
            ...
            function t() {
              var a = { parent: b.parentNode, position: v.getPropertyValue(b, "position"), fontSize: v.getPropertyValue(b, "fontSize") },
              ...
              var f = { overflowX: null, overflowY: null, boxSizing: null, width: null, minWidth: null, maxWidth: null, height: null, minHeight: null, maxHeight: null, paddingLeft: null },
                g = {},
                h = 10;
              ...
              (d && e) ||
                ...
                e ? (g.emToPxRatio = D.lastEmToPx) : v.setPropertyValue(b, "paddingLeft", h + "em"),
                d || ((g.percentToPxRatioWidth = D.lastPercentToPxWidth = (parseFloat(v.getPropertyValue(b, "width", null, !0)) || 1) / h), (g.percentToPxRatioHeight = D.lastPercentToPxHeight = (parseFloat(v.getPropertyValue(b, "height", null, !0)) || 1) / h)),
                e || (g.emToPxRatio = D.lastEmToPx = (parseFloat(v.getPropertyValue(b, "paddingLeft")) || 1) / h);
              for (var k in f) null !== f[k] && v.setPropertyValue(b, k, f[k]);
              return (
                o
                  ? (i && v.setPropertyValue(b, "width", "auto"), j && v.setPropertyValue(b, "height", "auto"))
                  : (v.setPropertyValue(b, "height", "auto"), f.height !== v.getPropertyValue(b, "height", null, !0) && v.setPropertyValue(b, "height", f.height), v.setPropertyValue(b, "width", "auto"), f.width !== v.getPropertyValue(b, "width", null, !0) && v.setPropertyValue(b, "width", f.width)),
                s.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(g), b),
                g
              );
            }
            if (0 === x && p && f(p.begin)) {
            ...
            if ("scroll" === A) {
              ...
              g.container
                ? g.container.jquery || g.container.nodeType
                  ? ((g.container = g.container[0] || g.container), (y = g.container["scroll" + C]), (B = y + r(b).position()[C.toLowerCase()] + F))
                  : (g.container = null)
                : ((y = s.State.scrollAnchor[s.State["scrollProperty" + C]]), (z = s.State.scrollAnchor[s.State["scrollProperty" + ("Left" === C ? "Top" : "Left")]]), (B = r(b).offset()[C.toLowerCase()] + F)),
                (h = { scroll: { rootPropertyValue: !1, startValue: y, currentValue: y, endValue: B, unitType: "", easing: g.easing, scrollData: { container: g.container, direction: C, alternateValue: z } }, element: b });
            } else if ("reverse" === A) {
              ...
              for (var J in n) {
                ...
                if (v.Names.prefixCheck(O)[1] !== !1 || v.Normalizations.registered[O] !== d) {
                  g.display && "none" !== g.display && /opacity|filter/.test(J) && !N && 0 !== L && (N = 0),
                    g._cacheValues && G && G[J] ? (N === d && (N = G[J].endValue + G[J].unitType), (P = r.data(b, l).rootPropertyValueCache[O])) : v.Hooks.registered[J] ? (N === d ? ((P = v.getPropertyValue(b, O)), (N = v.getPropertyValue(b, J, P))) : (P = v.Hooks.templates[O][1])) : N === d && (N = v.getPropertyValue(b, J));
                  var Q, R, S, T;
                  (Q = m(J, N)),
                    (N = Q[0]),
                    (S = Q[1]),
                  ...
                  (h[J] = { rootPropertyValue: P, startValue: N, currentValue: N, endValue: L, unitType: R, easing: M }), s.debug && console.log("tweensContainer (" + J + "): " + JSON.stringify(h[J]), b);
          ...
          switch (
            (r.data(b, l) === d && r.data(b, l, { isAnimating: !1, computedStyle: null, tweensContainer: null, rootPropertyValueCache: {}, transformCache: {} }),
            /^\d/.test(g.delay) &&
              g.queue !== !1 &&
          ...
          (g.easing = i(g.easing, g.duration)),
            ...
            (g.mobileHA = g.mobileHA && s.State.isMobile && !s.State.isGingerbread),
            g.queue === !1
              ? g.delay
            ...
            if (!r.isPlainObject(n) || r.isEmptyObject(n)) {
              if ("string" == typeof n && s.Sequences[n]) {
                var B = k,
                  C = p.duration;
                return (
                  p.backwards === !0 && (k = (k.jquery ? [].slice.call(k) : k).reverse()),
                  r.each(k, function (a, b) {
                    parseFloat(p.stagger) && (p.delay = parseFloat(p.stagger) * a), p.drag && ((p.duration = parseFloat(C) || (/^(callout|transition)/.test(n) ? 1e3 : m)), (p.duration = Math.max(p.duration * (p.backwards ? 1 - a / w : (a + 1) / w), 0.75 * p.duration, 200))), s.Sequences[n].call(b, b, p || {}, a, w);
                  }),
                  B
                );
              }
        ...
        var D = { lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPxRatio: null },
          E = [];
        if (u) k.each(a);
    ...
    w
      ...
      r.each(["Down", "Up"], function (a, b) {
        s.Sequences["slide" + b] = function (a, c) {
          var d = r.extend({}, c),
            e = { height: null, marginTop: null, marginBottom: null, paddingTop: null, paddingBottom: null, overflow: null, overflowX: null, overflowY: null },
            f = d.begin,
            g = d.complete,
            h = !1;
          (d.display = "Down" === b ? d.display || "block" : d.display || "none"),
            (d.begin = function () {
              function c() {
